...
namespace TayBot
{
    ...
    class Wordle
    {
        ...
        public static string MakeStringSpacedOut(string guess)
        {
        ...
        public static string GetEmojiFromResult(LetterResult result)
        {
            switch (result)
            {
